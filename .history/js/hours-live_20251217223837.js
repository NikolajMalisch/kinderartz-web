...
(function () {
    ...
    function addHeuteBadge(dayEl) {
        ...
        b.className =
            // ✅ "Heute" etwas weiter rechts: ml-2 -> ml-3 (und auf Desktop noch etwas mehr)
            "today-badge ml-3 sm:ml-4 inline-flex items-center whitespace-nowrap rounded-full bg-emerald-50 px-2.5 py-0.5 text-[11px] font-semibold text-emerald-700 ring-1 ring-emerald-100";
        b.textContent = "Heute";
        dayEl.appendChild(b);
    }
    ...
    function initBlock(scope) {
        ...
        // Einmal pro Stunde reicht (Mitternacht-Wechsel wird so sauber mitgenommen)
