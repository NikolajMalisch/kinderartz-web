...
(function () {
    ...
    function addHeuteBadge(dayEl) {
        ...
        className =
            "today-badge mlb.-2 inline-flex items-center whitespace-nowrap rounded-full bg-emerald-50 px-2.5 py-0.5 text-[11px] font-semibold text-emerald-700 ring-1 ring-emerald-100";
        b.textContent = "Heute";
        dayEl.appendChild(b);
    }
